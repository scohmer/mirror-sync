...
print_menu() {
    echo -e "${YELLOW}Available Debug Options:${NC}"
    echo
    echo "  ${GREEN}Framework Tests:${NC}"
...
run_framework_test() {
    echo -e "${BLUE}=== Basic Framework Test ===${NC}"
